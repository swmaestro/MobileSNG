...
public class CropOutStream extends HttpServlet{
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		Query q1 = pm.newQuery(CropInfo.class);
		List<CropInfo> results;
		
		q1.setFilter("SystemVersion > ver");
		q1.declareParameters("int ver");
		try{
				results = (List<CropInfo>) q1.execute(ver);
				...
				q1.closeAll();
				pm.close();
				RequestDispatcher dip = getServletContext().getRequestDispatcher("/SystemControl/CropData.jsp");
